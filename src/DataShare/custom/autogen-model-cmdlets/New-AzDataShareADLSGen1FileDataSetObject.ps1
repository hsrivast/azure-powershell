...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen1FileDataSetObject
#>
function New-AzDataShareADLSGen1FileDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen1FileDataSet')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(Mandatory, HelpMessage="The ADLS account name.")]
        [string]
        $AccountName,
        [Parameter(Mandatory, HelpMessage="The file name in the ADLS account.")]
        [string]
        $FileName,
        [Parameter(Mandatory, HelpMessage="The folder path within the ADLS account.")]
        [string]
        $FolderPath,
        [Parameter(Mandatory, HelpMessage="Resource group of ADLS account.")]
        [string]
        $ResourceGroup,
        [Parameter(Mandatory, HelpMessage="Subscription id of ADLS account.")]
        [string]
        $SubscriptionId,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen1FileDataSet]::New()
