...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FileDataSetMappingObject
#>
function New-AzDataShareADLSGen2FileDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FileDataSetMapping')]
    ...
    Param(
        ...
        [string]
        $DataSetId,
        [Parameter(Mandatory, HelpMessage="File path within the file system.")]
        [string]
        $FilePath,
        [Parameter(Mandatory, HelpMessage="File system to which the file belongs.")]
        [string]
        $FileSystem,
        [Parameter(HelpMessage="Type of output file.")]
        [ArgumentCompleter([Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType])]
        [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Support.OutputType]
        $OutputType,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FileDataSetMapping]::New()
