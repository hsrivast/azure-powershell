...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FileDataSetObject
#>
function New-AzDataShareADLSGen2FileDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FileDataSet')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FileDataSet]::New()
