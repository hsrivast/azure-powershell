...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FileSystemDataSetMappingObject
#>
function New-AzDataShareADLSGen2FileSystemDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FileSystemDataSetMapping')]
    ...
    Param(
        ...
        [string]
        $DataSetId,
        [Parameter(Mandatory, HelpMessage="The file system name.")]
        [string]
        $FileSystem,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FileSystemDataSetMapping]::New()
