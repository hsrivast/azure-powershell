...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FolderDataSetMappingObject
#>
function New-AzDataShareADLSGen2FolderDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FolderDataSetMapping')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ADLSGen2FolderDataSetMapping]::New()
