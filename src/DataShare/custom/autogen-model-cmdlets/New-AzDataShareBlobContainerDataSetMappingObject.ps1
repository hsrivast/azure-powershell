...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobContainerDataSetMappingObject
#>
function New-AzDataShareBlobContainerDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobContainerDataSetMapping')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(Mandatory, HelpMessage="BLOB Container name.")]
        [string]
        $ContainerName,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobContainerDataSetMapping]::New()
