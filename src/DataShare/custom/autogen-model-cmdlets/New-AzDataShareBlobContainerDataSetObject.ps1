...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobContainerDataSetObject
#>
function New-AzDataShareBlobContainerDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobContainerDataSet')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobContainerDataSet]::New()
