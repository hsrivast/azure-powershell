...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobDataSetMappingObject
#>
function New-AzDataShareBlobDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobDataSetMapping')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(Mandatory, HelpMessage="Container that has the file path.")]
        [string]
        $ContainerName,
        [Parameter(Mandatory, HelpMessage="The id of the source data set.")]
        [string]
        $DataSetId,
        [Parameter(Mandatory, HelpMessage="File path within the source data set.")]
        [string]
        $FilePath,
        [Parameter(HelpMessage="File output type.")]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobDataSetMapping]::New()
