...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobDataSetObject
#>
function New-AzDataShareBlobDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobDataSet')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobDataSet]::New()
