...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobFolderDataSetMappingObject
#>
function New-AzDataShareBlobFolderDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobFolderDataSetMapping')]
    ...
    Param(
        ...
        [string]
        $DataSetId,
        [Parameter(Mandatory, HelpMessage="Prefix for blob folder.")]
        [string]
        $Prefix,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobFolderDataSetMapping]::New()
