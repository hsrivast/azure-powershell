...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobFolderDataSetObject
#>
function New-AzDataShareBlobFolderDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobFolderDataSet')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobFolderDataSet]::New()
