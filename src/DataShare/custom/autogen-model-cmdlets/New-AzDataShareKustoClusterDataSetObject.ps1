...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareKustoClusterDataSetObject
#>
function New-AzDataShareKustoClusterDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoClusterDataSet')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(Mandatory, HelpMessage="Resource id of the kusto cluster.")]
        [string]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoClusterDataSet]::New()
