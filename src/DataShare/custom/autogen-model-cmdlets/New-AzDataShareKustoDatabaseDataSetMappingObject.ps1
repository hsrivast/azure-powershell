...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareKustoDatabaseDataSetMappingObject
#>
function New-AzDataShareKustoDatabaseDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoDatabaseDataSetMapping')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoDatabaseDataSetMapping]::New()
