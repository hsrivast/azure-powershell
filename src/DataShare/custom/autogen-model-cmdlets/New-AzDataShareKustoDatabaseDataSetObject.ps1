...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareKustoDatabaseDataSetObject
#>
function New-AzDataShareKustoDatabaseDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoDatabaseDataSet')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoDatabaseDataSet]::New()
