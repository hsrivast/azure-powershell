...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareKustoTableDataSetMappingObject
#>
function New-AzDataShareKustoTableDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoTableDataSetMapping')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoTableDataSetMapping]::New()
