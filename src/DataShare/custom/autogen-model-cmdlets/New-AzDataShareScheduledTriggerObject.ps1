...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareScheduledTriggerObject
#>
function New-AzDataShareScheduledTriggerObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ScheduledTrigger')]
    ...
    Param(
        ...
        $RecurrenceInterval,
        [Parameter(HelpMessage="Synchronization mode.")]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ScheduledTrigger]::New()

        if ($PSBoundParameters.ContainsKey('RecurrenceInterval')) {
            $Object.RecurrenceInterval = $RecurrenceInterval
        }
        if ($PSBoundParameters.ContainsKey('SynchronizationMode')) {
            $Object.SynchronizationMode = $SynchronizationMode
        }
