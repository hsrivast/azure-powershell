...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSqlDBTableDataSetMappingObject
#>
function New-AzDataShareSqlDBTableDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDBTableDataSetMapping')]
    ...
    Param(
        ...
        [string]
        $DataSetId,
        [Parameter(Mandatory, HelpMessage="DatabaseName name of the sink data set.")]
        [string]
        $DatabaseName,
        ...
        [string]
        $SqlServerResourceId,
        [Parameter(Mandatory, HelpMessage="SQL DB table name.")]
        [string]
        $TableName,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDBTableDataSetMapping]::New()
