...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSqlDBTableDataSetObject
#>
function New-AzDataShareSqlDBTableDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDBTableDataSet')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(HelpMessage="Database name of the source data set.")]
        [string]
        $DatabaseName,
        ...
        [string]
        $SqlServerResourceId,
        [Parameter(HelpMessage="SQL DB table name.")]
        [string]
        $TableName,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDBTableDataSet]::New()
