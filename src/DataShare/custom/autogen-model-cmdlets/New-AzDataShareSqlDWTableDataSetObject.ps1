...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSqlDWTableDataSetObject
#>
function New-AzDataShareSqlDWTableDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDWTableDataSet')]
    [CmdletBinding(PositionalBinding=$false)]
    Param(

        [Parameter(HelpMessage="DataWarehouse name of the source data set.")]
        [string]
        $DataWarehouseName,
        [Parameter(HelpMessage="Schema of the table. Default value is dbo.")]
        [string]
        $SchemaName,
        [Parameter(HelpMessage="Resource id of SQL server.")]
        [string]
        $SqlServerResourceId,
        [Parameter(HelpMessage="SQL DW table name.")]
        [string]
        $TableName,
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDWTableDataSet]::New()
