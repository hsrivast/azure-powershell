...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSynapseWorkspaceSqlPoolTableDataSetMappingObject
#>
function New-AzDataShareSynapseWorkspaceSqlPoolTableDataSetMappingObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SynapseWorkspaceSqlPoolTableDataSetMapping')]
    ...
    Param(
        ...
        [string]
        $DataSetId,
        [Parameter(Mandatory, HelpMessage="Resource id of the Synapse Workspace SQL Pool Table.")]
        [string]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SynapseWorkspaceSqlPoolTableDataSetMapping]::New()

        if ($PSBoundParameters.ContainsKey('DataSetId')) {
            $Object.DataSetId = $DataSetId
        }
        if ($PSBoundParameters.ContainsKey('SynapseWorkspaceSqlPoolTableResourceId')) {
            $Object.SynapseWorkspaceSqlPoolTableResourceId = $SynapseWorkspaceSqlPoolTableResourceId
        }
