...
.Link
https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSynapseWorkspaceSqlPoolTableDataSetObject
#>
function New-AzDataShareSynapseWorkspaceSqlPoolTableDataSetObject {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SynapseWorkspaceSqlPoolTableDataSet')]
    ...
    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SynapseWorkspaceSqlPoolTableDataSet]::New()
