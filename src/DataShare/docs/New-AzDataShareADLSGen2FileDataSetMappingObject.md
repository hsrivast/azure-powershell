...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FileDataSetMappingObject
schema: 2.0.0
---

# New-AzDataShareADLSGen2FileDataSetMappingObject
...
```
New-AzDataShareADLSGen2FileDataSetMappingObject -DataSetId <String> -FilePath <String> -FileSystem <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.AdlsGen2FileDataSetMapping
