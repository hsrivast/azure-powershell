...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FileDataSetObject
schema: 2.0.0
---

# New-AzDataShareADLSGen2FileDataSetObject
...
```
New-AzDataShareADLSGen2FileDataSetObject -FilePath <String> -FileSystem <String> -Kind <DataSetKind>
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.AdlsGen2FileDataSet
