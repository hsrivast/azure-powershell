...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareADLSGen2FolderDataSetObject
schema: 2.0.0
---

# New-AzDataShareADLSGen2FolderDataSetObject
...
```
New-AzDataShareADLSGen2FolderDataSetObject -FileSystem <String> -FolderPath <String> -Kind <DataSetKind>
