...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobContainerDataSetObject
schema: 2.0.0
---

# New-AzDataShareBlobContainerDataSetObject
...
```
New-AzDataShareBlobContainerDataSetObject -ContainerName <String> -Kind <DataSetKind> -ResourceGroup <String>
 -StorageAccountName <String> -SubscriptionId <String> [-SystemDataCreatedAt <DateTime>]
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobContainerDataSet
