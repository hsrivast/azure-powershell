...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobDataSetObject
schema: 2.0.0
---

# New-AzDataShareBlobDataSetObject
...
```
New-AzDataShareBlobDataSetObject -ContainerName <String> -FilePath <String> -Kind <DataSetKind>
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobDataSet
