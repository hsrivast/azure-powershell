...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareBlobFolderDataSetMappingObject
schema: 2.0.0
---

# New-AzDataShareBlobFolderDataSetMappingObject
...
```
New-AzDataShareBlobFolderDataSetMappingObject -ContainerName <String> -DataSetId <String>
 -Kind <DataSetMappingKind> -Prefix <String> -ResourceGroup <String> -StorageAccountName <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.BlobFolderDataSetMapping
