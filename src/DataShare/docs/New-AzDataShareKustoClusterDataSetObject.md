...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareKustoClusterDataSetObject
schema: 2.0.0
---

# New-AzDataShareKustoClusterDataSetObject
...
```
New-AzDataShareKustoClusterDataSetObject -Kind <DataSetKind> -KustoClusterResourceId <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoClusterDataSet
