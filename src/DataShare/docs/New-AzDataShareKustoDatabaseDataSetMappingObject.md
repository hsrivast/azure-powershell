...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareKustoDatabaseDataSetMappingObject
schema: 2.0.0
---

# New-AzDataShareKustoDatabaseDataSetMappingObject
...
```
New-AzDataShareKustoDatabaseDataSetMappingObject -DataSetId <String> -Kind <DataSetMappingKind>
 -KustoClusterResourceId <String> [-SystemDataCreatedAt <DateTime>] [-SystemDataCreatedBy <String>]
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.KustoDatabaseDataSetMapping
