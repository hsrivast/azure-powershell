...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareScheduledTriggerObject
schema: 2.0.0
---

# New-AzDataShareScheduledTriggerObject
...
```
New-AzDataShareScheduledTriggerObject -RecurrenceInterval <RecurrenceInterval> -SynchronizationTime <DateTime>
 [-SynchronizationMode <SynchronizationMode>] [-SystemDataCreatedAt <DateTime>]
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.ScheduledTrigger
