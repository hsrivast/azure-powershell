...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSqlDBTableDataSetMappingObject
schema: 2.0.0
---
...
```
New-AzDataShareSqlDBTableDataSetMappingObject -DatabaseName <String> -DataSetId <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.SqlDbTableDataSetMapping
