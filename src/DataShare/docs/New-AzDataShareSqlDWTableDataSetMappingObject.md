...
online version: https://docs.microsoft.com/powershell/module/az.DataShare/new-AzDataShareSqlDWTableDataSetMappingObject
schema: 2.0.0
---

# New-AzDataShareSqlDWTableDataSetMappingObject
...
```
New-AzDataShareSqlDWTableDataSetMappingObject -DataSetId <String> -DataWarehouseName <String>
 -Kind <DataSetMappingKind> -SchemaName <String> -SqlServerResourceId <String> -TableName <String>
