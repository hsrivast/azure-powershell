...
### Delete (Default)
```
Remove-AzDataShareAccount -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDataShareAccount -InputObject <IDataShareIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.Api20210801.IOperationResponse
